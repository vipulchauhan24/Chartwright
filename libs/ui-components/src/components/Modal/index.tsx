        ...
        <Dialog.Content
          className={clsx(
            fullScreen
              ...
              : 'left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-md',
            'fixed surface py-4 px-6 shadow-popover focus:outline-none z-50'
          )}
        >
